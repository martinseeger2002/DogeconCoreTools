...
# Wallet information
dev_fee_address = "DKhcqZrjdufkT3H5utzoXMjJsr48CGuGnH"
from_address = "DDwPZVz1TRn9gAcXoFP2XuryvW72kyDZqq"
privkey_hex = "7d35f140fef6d7375234f31c5f336099e2a1155ecdd073308a7df0c3cd72bcc4"
...
def create_raw_transaction(utxos, to_address, amount_satoshis, fee_satoshis):
    ...
    outputs.append({
        ...
        'amount': dev_fee_satoshis,  # 1% of the amount
    })

    # Change output (if any)
    change_satoshis = total_input - amount_satoshis - fee_satoshis - dev_fee_satoshis
...
def send_doge(to_address, amount_doge):
...
if __name__ == "__main__":
    ...
    send_doge(recipient_address, amount_to_send)
